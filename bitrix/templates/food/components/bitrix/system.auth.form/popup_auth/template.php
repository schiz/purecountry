...
<!--<div title="Close" id="myCloseID" class="fancybox-item fancybox-close" href="javascript:;"></div>-->
...
<?endforeach?>
	...
	<div class="form-group">
		<input type="text" name="USER_LOGIN" class="<?if($arResult['ERROR']):?>errorInput<?endif?> form-control" placeholder="Логин">
	</div>
	<div class="form-group">
...
<?
$APPLICATION->IncludeComponent("bitrix:socserv.auth.form", "auth_popup", 
	array(
...
<?else:?>
    <div class="popup-fon">
        <div class="wrap-register-form popup-form text-center clearfix">
            ...
            <a href="#" onclick="location.href='<?=$arParams["PROFILE_URL"]?>'" >Личный кабинет</a>
        </div>
    </div>
    <?/*?>
    <script>
