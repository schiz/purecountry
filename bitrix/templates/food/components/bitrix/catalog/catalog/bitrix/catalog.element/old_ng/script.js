...
console.log('my error='+this.errorCode);
	if (0 === this.errorCode)
	{
		var SliderImgs = null;
		if (this.showQuantity)
		{
            ...
            upProd = function() {
                //var obj = obQuantityUp;
                console.log(this.obQuantityUp.id);
                //console.log(ev);                
            }
			//BX.bind(this.obQuantityUp, 'click', BX.delegate(upProd, this));
	...
	case 2://set
        ...
        BX.ajax.loadJSON(strBasket, function(data){
            ...
            {   
                ...
                arDialogParams = {
                   'title' : 'Уведомление',
                   'content' : '<div>Товар добавлен в корзину</div>',
                   'width' : 400,
                   'height' : 200,
                   'buttons' : [                        
                ...
                popMess = new BX.CDialog(arDialogParams);
                popMess.Show();
                setTimeout('popMess.Close();', 3000);
