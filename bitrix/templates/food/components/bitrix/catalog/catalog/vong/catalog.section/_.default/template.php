...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
    ...
    <div class="col-xs-6 col-sm-4 col-md-3 <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">
        <?if($arItem['SPECIAL']) echo 'its special';?>
        <div class="item text-center bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a id="<? echo $arItemIDs['PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
			class="preview-image bx_catalog_item_images"
	...
	?>
            <hgroup>
                <div class="section-name"><?=$arItem['NAME']?></div>						
                <h4>
                    <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="catalog-item-link text-center"><?=$arItem['NAME']?></a>
                </h4>
            </hgroup>
