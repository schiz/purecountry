...
<?/*
<script type="text/javasctipt" src="http://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.pack.js"></script>
<script type="text/javasctipt" src="http://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.js"></script>
*/?>
...
<?/*<link rel="stylesheet" type="text/css" href="http://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.css" ></link>*/?>
<?
...
//include js & style by social auth form
...
<?endif?>
    ...
    <div id="basket_small_block">
        <?if($USER->IsAuthorized()):?>
            <a href="?logout=yes" id="icon_logout" title="Выйти" class="various" >
                <img src="<?=SITE_TEMPLATE_PATH?>/images/logout.png" alt="Выйти"/>
            </a>
            <a href="/personal/" id="icon_userinfo" title="Личный кабинет" class="various" >
                <img src="<?=SITE_TEMPLATE_PATH?>/images/user_info.png" alt="Мой кабинет"/>
            </a>
        <?else:?>
            <a href="/auth/?ajax=Y" id="icon_login" title="Авторизоваться" class="various fancybox.ajax" >
                <img src="<?=SITE_TEMPLATE_PATH?>/images/login.png" alt="Авторизоваться"/>
            </a>
        <?endif;?>
        <a href="/personal/cart/"   title="В корзину"> 
            <img src="<?=SITE_TEMPLATE_PATH?>/images/basket_small_img.png" alt="Корзина"/>
        </a>
    </div>
	<nav class="navbar">
